...
The core analytical methods that make up the foundation of data science can be grouped into three classes: descriptive, predictive, and prescriptive. I use these three classes to classify data scientists according to their work. For a better and more detailed classification than mine, you can read Cem Vardar's article [The Types of Data Science](https://decisionsciencelab.com/posts/veri-bilimciliginin-cesitleri/). Although the logic behind Cem's framework is similar to mine, he provides a more specific classification.
